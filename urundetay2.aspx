<%@ Page Title="" Language="C#" Theme="Tasarim" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="urundetay2.aspx.cs" Inherits="urundetay2" %>
  ...
  <asp:DataList ID="DataList1" runat="server">
    ...
    <div style="margin-left:450px; margin-top:50px;">
        <asp:Label ID="Label1" 
            ...
            <div style="margin-left:480px; margin-top:15px;"><asp:Label ID="Label6" runat="server" Text="Kitabın Adı:" Font-Size="20px" ForeColor="Gray"></asp:Label></div>
    <div style="margin-left:500px; margin-top:15px;"><asp:Label ID="Label7"  runat="server"  ForeColor="Black"></asp:Label><%#Eval("ad") %></div>
      <div style="margin-left:480px; margin-top:15px;"><asp:Label ID="Label8" runat="server" Text="Piyasadaki Fiyat Aralığı:" Font-Size="20px" ForeColor="Gray"></asp:Label></div>
    <div style="margin-left:500px; margin-top:15px;"><asp:Label ID="Label9"  runat="server"  ForeColor="Black"></asp:Label><%#Eval("fiyat") %></div>
    <div style="margin-left:480px; margin-top:15px;"><asp:Label ID="Label2" runat="server" Text="Yayınevi" Font-Size="20px" ForeColor="Gray"></asp:Label></div>
    <div style="margin-left:500px; margin-top:15px;"><asp:Label ID="sis"  runat="server"  ForeColor="Black"></asp:Label><%#Eval("kategory") %></div>
     <div style="margin-left:480px; margin-top:15px;"><asp:Label ID="Label3"  runat="server" Text="Kitap Hakkındaki Yorumlar" Font-Size="20px" ForeColor="Gray"></asp:Label></div>
     <div style="margin-left:500px; margin-top:15px;"><asp:Label ID="islem"  runat="server"  ForeColor="Black"></asp:Label><%#Eval("hd") %></div>
     <div style="margin-left:480px; margin-top:15px;"><asp:Label ID="Label4" runat="server" Text="Ders" Font-Size="20px" ForeColor="Gray"></asp:Label></div>
     ...
     <div style="margin-left:440px; margin-top:15px;">
        ...
        <div style="margin-left:1190px; margin-top:-200px; width:250px; margin-left:500px;">
            <asp:Button style="margin-left:450px;"  ID="giris" runat="server" Text="Geri Dön" 
