<%@ Page Title="" Language="C#" Theme="Tasarim" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="urunler.aspx.cs" Inherits="urunler" %>
 ...
 <div id="wrapper" style="height:200px; margin-left:400px; margin-top:-430px;">
				<div id="slider-wrapper" style="height:200px;">        
					<div id="slider" class="nivoSlider" style="height:200px;">
						<img src="resimler/ygs1.png" alt="" />
						<img src="resimler/ygs2.png" alt=""/>
						<img src="resimler/ygs3.png" alt="" />
						<img src="resimler/ygs4.png" alt="" />
                        <img src="resimler/ygs5.png" alt="" />
                        <img src="resimler/ygs6.png" alt="" />
...
<script type="text/javascript" src="lib/jquery-1.4.3.min.js"></script>
    ...
    <ItemTemplate>
     ...
     <div><a href="urundetay.aspx?urun_id=<%# Eval("urun_id") %>">
