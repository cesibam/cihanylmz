<%@ Page Title="" Language="C#" Theme="Tasarim" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="urundetay4.aspx.cs" Inherits="urundetay4" %>
  ...
  <asp:DataList ID="DataList1" runat="server">
    ...
    <div style="margin-left:450px; margin-top:50px;">
        <asp:Label ID="Label1" 
            ...
            <div style="margin-left:480px; margin-top:15px;"><asp:Label ID="Label6" runat="server" Text="Kitabın adı Adı:" Font-Size="20px" ForeColor="Gray"></asp:Label></div>
