<%@ Page Title="" Language="C#" Theme="Tasarim" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="urunler2.aspx.cs" Inherits="urunler2" %>
 ...
 <div id="wrapper" style="height:200px; margin-left:400px; margin-top:-430px;">
				<div id="slider-wrapper" style="height:200px;">        
					<div id="slider" class="nivoSlider" style="height:200px;">
						<img src="resimler/lys1.png" alt="" />
						<img src="resimler/lys2.png" alt=""/>
						<img src="resimler/lys3.png" alt="" />
						<img src="resimler/lys4.png" alt="" />
                        <img src="resimler/lys5.png" alt="" />
                        <img src="resimler/lys6.png" alt="" />
...
<script type="text/javascript" src="lib/jquery-1.4.3.min.js"></script>
    ...
    <ItemTemplate>
     ...
     <div><a href="urundetay2.aspx?urun_id=<%# Eval("urun_id") %>">
