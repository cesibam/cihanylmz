<%@ Page Title="" Language="C#" Theme="Tasarim" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="urunler4.aspx.cs" Inherits="urunler4" %>
 ...
 <div id="wrapper" style="height:200px; margin-left:400px; margin-top:-430px;">
				<div id="slider-wrapper" style="height:200px;">        
					<div id="slider" class="nivoSlider" style="height:200px;">
						<img src="resimler/kpss1.png" alt="" />
						<img src="resimler/kpss2.png" alt=""/>
						<img src="resimler/kpss3.png" alt="" />
						<img src="resimler/kpss4.png" alt="" />
                        <img src="resimler/kpss5.png" alt="" />
                        <img src="resimler/kpss6.png" alt="" />
...
<script type="text/javascript" src="lib/jquery-1.4.3.min.js"></script>
    ...
    <ItemTemplate>
     ...
     <div><a href="urundetay4.aspx?urun_id=<%# Eval("urun_id") %>">
